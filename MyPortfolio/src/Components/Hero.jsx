  ...
  return (
    ...
    <div className="hero-container">
      <motion.div className="hero-content" variants={staggerContainer} initial="initial" animate="animate">
        ...
        <motion.h2 className="hero-subtitle" variants={fadeInUp}>Creative Full-stack Developer</motion.h2>
      ...
      <motion.a href="https://www.instagram.com/bhosalevaishanav/" target="_blank"><i className="fab fa-instagram" ></i></motion.a>
      </motion.div>
      </motion.div> 
